...
export const Copy = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
...
export const Database = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Close = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Menu = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Light = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Dark = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Search = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Refresh = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Add = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Left = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Right = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Portrait = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Landscape = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Square = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Settings = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Calendar = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Variable = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Bookmark = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Resources = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Contacts = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Broadcast = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Share = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const Dashboard = ({ fillColor = "#000", className = "" }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
